...
public class FactoryPatternDemo {
	public static void main(String[] args) {
	      ...
	      /*
m
	      Coffee coffee1 = coffeeFactory.getCoffee("coffeeA");
          coffee1.coffee_ingridients();
          System.out.println("\tPrice:"+coffee1.price());
          
          Coffee coffee2 = coffeeFactory.getCoffee("coffeeB");
          coffee2.coffee_ingridients();
          System.out.println("\tPrice:"+coffee2.price());
          
          Coffee coffee3 = coffeeFactory.getCoffee("coffeeA");
          coffee3.coffee_ingridients();
          System.out.println("\tPrice:"+coffee3.price());
          */
